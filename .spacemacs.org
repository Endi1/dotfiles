       ...
       (org :variables
            ...
            '(
              ...
              ("w" "Work Todo" entry (file+headline "~/Notes/notebook/work.org" "Tasks")
               "* TODO %?\n%U")
              ("s" "Sprint Planning" entry (file+headline "~/Notes/notebook/work.org" "Sprint planning")
               "* TODO %?\n%U")
...
* TODO Improve separation of concern between parts of the config
** [[https://michal.sapka.me/emacs/org-babel/][[Michał Sapka's website] Executing code in Org files with Babel]] :website:

[2024-02-12 lun 18:41]
...
This mode gives quite a lot more option. You can read about them inside [[https://orgmode.org/manual/Noweb-Reference-Syntax.html][manual]].
...
And then, after any changes of the file run =org-babel-tangle= and your =init.el= will be up-to-date. This is the approach [[https://protesilaos.com/codelog/2023-12-18-emacs-org-advanced-literate-conf/][Prot]] uses, but his config consists of over /17_000/ [sic!] lines of org file, so your mileage may vary.
